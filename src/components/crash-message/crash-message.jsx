...
const CrashMessage = props => (
    <div className={styles.crashWrapper}>
        <Box className={styles.body}>
            ...
            <p>
                <FormattedMessage
                    defaultMessage={'We are so sorry, but it looks like RoboPro has crashed. This bug has been' +
                        ' automatically reported to the RoboPro Team. Please refresh your page to try' +
                        ' again.'}
