...
import ArgumentType from 'robopro-vm/src/extension-support/argument-type';
import BlockType from 'robopro-vm/src/extension-support/block-type';
...
const defineDynamicBlock = (ScratchBlocks, categoryInfo, staticBlockInfo, extendedOpcode) => ({
    init: function () {
        ...
        // There is a robopro-blocks / Blockly extension called "scratch_extension" which adjusts the styling of
        // blocks to allow for an icon, a feature of Scratch extension blocks. However, Scratch "core" extension
        // blocks don't have icons and so they should not use 'scratch_extension'. Adding a robopro-blocks / Blockly
