...
import ScratchBlocks from 'robopro-blocks';
...
export default function (blockId) {
    // Not sure any better way to access the robopro-blocks workspace than this...
    ...
    return new Promise(resolve => {
        setTimeout(() => {
            ...
            computedStyleToInlineStyle(svg, {
                ...
                // Specifically properties that are set from CSS in robopro-blocks
